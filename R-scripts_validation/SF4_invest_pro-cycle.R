...
investment <- aggregate(run[, "investmentPool"], list(df$time), mean)
sdInvestment <- aggregate(run[, "investmentPool"], list(df$time), sd)
price <- aggregate(run[, "prices"], list(run$time), mean)
...
mtm$investment <- investment$investment
mtm$sdInvestment <- sdInvestment$investment


mtm$price <- price$prices
